...
def create_dataset(
    ...
    part='trainval',
    **kwargs):
  assert name in ['market1501', 'cuhk03', 'duke', 'combined', 'generate_market1501'], \
  ...
  elif name == 'generate_market1501':
    im_dir = ospeu('../../Dataset/pngan_market_1_1/images')   
    partition_file = ospeu('../../Dataset/pngan_market_1_1/partitions.pkl')  
  ##################
  # Create Dataset #
  ##################
